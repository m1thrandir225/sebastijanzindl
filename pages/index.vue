        ...
        <div
            ...
            <div class="my-4">
                <p class="font-sans text-lg text-neutral-900 dark:text-neutral-100 relative z-[80]">
                    ...
                    <NuxtLink
                        ...
                        to="https://piksel.mk" target="_blank">Piksel</NuxtLink>
                </p>
                <p class="font-sans text-lg text-neutral-900 dark:text-neutral-100 relative z-[80]">
                    Currently learning:
            ...
            <div class="my-4">
                ...
                <div class="flex flex-row flex-wrap w-full gap-2 my-2">
                    <NuxtLink v-for="link in customPropertiesHome?.socialLinks" :key="link._key" :to="link.url"
                        target="_blank"
            ...
            <div style="transform: translateZ(0)"
                class="absolute z-40 bottom-[50px] right-[25%] bg-orange-400/50 rounded-full w-96 h-96 mix-blend-multiply dark:mix-blend-soft-light blur-3xl filter animate-zoom-right animation-delay-4000" />

            <div style="transform: translateZ(0)"
                class="absolute z-40 bottom-[100px] right-[50%] bg-pink-400/50 rounded-full w-64 h-64 mix-blend-multiply dark:mix-blend-soft-light blur-3xl filter animate-zoom-right animation-delay-2000" />
        </div>
        <div
            ...
            <div class="flex flex-row flex-wrap items-start gap-2 relative z-[150]">
                <div v-for="tool in customPropertiesHome?.using" :key="tool._key"
                    ...
                    <SanityImage :image="tool.logo" :asset-id="tool.logo.asset._ref" class="w-10 h-10" alt="tool.name" />
                </div>
            </div>
        </div>
    </div>
