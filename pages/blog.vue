<template>
    <div class="flex flex-col items-start w-full h-full gap-2 justify-start">
        <div class="flex flex-col items-start gap-2 p-4 justify-start md:p-0">
            <h1
            ...
            <p
                class="font-sans text-lg font-medium dark:text-neutral-100 text-neutral-800"
            >
                Maybe I'll write something here, maybe not.
            </p>
        </div>
        <div
...
useSeoMeta({
    title: 'Sebastijan Zindl - Blog',
    description: "Maybe I'll write something here, maybe not.",
    ogTitle: 'Sebastijan Zindl - Blog',
    ogDescription: "Maybe I'll write something here, maybe not.",
    ogType: 'website',
